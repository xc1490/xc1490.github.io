...
function updateMusicClip() {
  if (noise_level_id==10) document.getElementById("noise_type_selector").classList.add("inactive");
  if (noise_level_id!=10) document.getElementById("noise_type_selector").classList.remove("inactive");
